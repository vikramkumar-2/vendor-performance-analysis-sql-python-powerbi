...
<div align="center">
<img src="./assets/dashboard.png" alt="Vendor Performance Dashboard" width="100%">
</div>
...
| **Reporting** | Microsoft Word (analytical report) |
...
│
├── Vendor_Performance.ipynb                   # Data ingestion notebook (SQL joins & loading)
├── Exploratory_Data_Analysis.ipynb            # EDA — distributions, outliers, correlations
├── Vendor_Performance_Analysis.ipynb          # Core analysis — hypothesis testing & KPIs
│
├── Vendor_Performance_Analysis_-_Report.docx  # Full written business report
└── README.md
```
...
7. **Reporting** — Findings compiled into a formal business report and an interactive Power BI dashboard.
...
- 📘 **[Vendor Performance Analysis Report](./Vendor_Performance_Analysis_-_Report.docx)** — full written analysis with all figures and tables
- 📓 **Notebooks** — ingestion, EDA, and statistical analysis, fully reproducible
- 📊 **Power BI Dashboard** — live vendor, brand, and inventory monitoring view
