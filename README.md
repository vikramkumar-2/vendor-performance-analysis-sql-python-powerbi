...
### Turning Millions+ raw transactions into vendor, brand & inventory intelligence
...
1. **Ingestion** — Raw CSVs (including a Millions+ -row sales table) loaded into SQLite in chunks of 100,000 rows for memory efficiency.
